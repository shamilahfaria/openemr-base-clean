...
<body class="min-vw-100">
    ...
    <div id="mainBox" <?php echo $disp_mainBox ?>>
        <nav class="navbar navbar-expand-xl navbar-light bg-light py-0">
            ...
            <?php $copilotAuthUser = (string)$session->get('authUser'); ?>
            <a class="btn btn-sm btn-outline-info my-1 mx-2" href="<?php echo attr(copilotLaunchUrl(null, $copilotAuthUser, copilotIsDemoAdmin($copilotAuthUser))); ?>" title="<?php echo xla('Open the Clinical Co-Pilot (AI assistant) in a new tab'); ?>" rel="noopener" target="_blank"><i class="fa fa-robot mr-1"></i><?php echo xlt('Co-Pilot'); ?></a>
